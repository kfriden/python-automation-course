...
grades = int(input("Enter your grades here"))
...
move_rating1 = int(input("Enter a movie rating: "))
move_rating2 = int(input("Enter a second movie rating: "))

if move_rating1 >= 7 and move_rating2 >= 7:
...
hunger_level = input("What's your hunger level, high or low?")

if mood == "happy" and hunger_level == "high":
    print("How about a fancy place to eat?")
elif mood == "sad" and hunger_level == "hungry":
    print("How about some comfort food tonight?")
else:
    print("How about a casual dining place tonight?")
...
if annual_income > 100000:
    tax_amount = annual_income * 0.30
    print(f"Your tax amount is {tax_amount}")
elif annual_income <= 100000 and annual_income >= 40000:
    tax_amount2 = annual_income * 0.20
    print(f"Your tax amount is {tax_amount2}")
else:
    tax_amount3 = annual_income * 0.10
    print(f"Your tax amount is {tax_amount3}")
...
if age >= 3 and age <= 12:
    ...
    seniors = 15
    print(f"The ticket price is {seniors}")
...
if course_suffix == "101":
    if student_grade == "A" or student_grade == "B":
        print("You are eligible to take this course")
    elif student_grade == "C" or student_grade == "D":
        print("You are not eligible to take this course")
